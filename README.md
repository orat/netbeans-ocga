...
This is a plugin for the Netbeans-IDE which includes a ".ga"-file type for including geometric algebra code in the specific [DSL](https://github.com/MobMonRob/DSL4GeometricAlgebra).
